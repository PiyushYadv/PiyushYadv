# About Me:
I’m currently working on building engaging web applications with modern UI/UX design principles.<br>I’m looking to collaborate on creative design-driven projects, open-source tools, or apps that focus on user-friendly interfaces and seamless experiences.<br>I’m currently learning Spring Boot, Rust, Go, Graph Neural Networks, and advanced problem-solving techniques for competitive programming.<br>Ask me about UI/UX design, Full Stack development, CS Fundamentals, and practical approaches to coding problems.
